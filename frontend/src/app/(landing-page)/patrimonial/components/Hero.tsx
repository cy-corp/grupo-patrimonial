  ...
  return (
    <section className="relative w-full overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-12 lg:px-24">
          ...
          >
            ...
            <p className="font-sans text-[#0F172A]/70 text-xl leading-relaxed tracking-wide max-w-xl border-l-2 border-[#C9A14A]/30 pl-8">
              A Incorporadora Patrimonial atua na gestão estratégica, organização e valorização do patrimônio imobiliário, com foco em visão de longo prazo e segurança jurídica.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="md:hidden flex flex-col bg-[#F8F1E3]">
        ...
        <div className="relative -mt-28 bg-[#F8F1E3] rounded-t-[3rem] px-8 pt-12 pb-16 z-10 shadow-2xl">
          ...
          <h1 className="font-heading text-4xl sm:text-5xl font-black uppercase tracking-tight leading-tight text-[#0F172A] mb-6">
            GESTÃO<br />
            <span className="text-[#C9A14A] italic">PATRIMONIAL</span>
          </h1>
          <div className="w-16 h-1 bg-[#C9A14A] mb-6" />
          <p className="font-sans text-[#0F172A]/80 text-lg leading-relaxed">
            Gestão estratégica e valorização do patrimônio imobiliário com foco em visão de longo prazo e segurança.
          </p>
        </div>
      </div>
    </section>
